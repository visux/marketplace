...
function CreateItem(props: Props) {
  ...
  async function createMarketSale(tokenURI: string) {
    ...
    let transaction = await tokenContract.createSonikchain(tokenURI);
    ...
    <div className="w-full md:w-1/2 mt-28">
      ...
      <form onSubmit={handleSubmit} className="mt-8">
        <div className="space-y-6">
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                value={inputs.name}
                className="block w-full h-10 bg-[#02011a] border-none rounded-lg focus:ring-primary sm:text-sm"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <textarea
                ...
                className="block w-full h-24 mt-1 border-none rounded-lg shadow-sm bg-[#02011a] focus:ring-primary sm:text-sm"
              />
            </div>
          ...
          <div>
            ...
            {preview && (
              <div className="mt-4">
                <label
                  htmlFor="image"
                  className="p-3 text-sm text-white bg-defaultcol rounded-md cursor-pointer"
                >
                  Change Image
                  <input
                    id="image"
          ...
          <div className="relative w-1/2 rounded-md shadow-sm">
            ...
            <input
              ...
              className="block w-full h-10 pr-16 bg-[#02011a] border-none rounded-lg focus:ring-primary sm:text-sm"
              placeholder="0.5"
              step=".1"
            />
            <div className="absolute inset-y-0 right-0 flex items-center h-10 mt-6">
              <div className="absolute inset-y-0 right-0 flex items-center px-4 ml-3 font-semibold rounded-r-lg pointer-events-none bg-primary text-intercol">
                ETH
              </div>
            </div>
          </div>
        ...
        <div className="mt-8">
          <button
            type="submit"
            className="w-1/5 py-2 font-semibold rounded-full bg-primary text-md text-intercol"
          >
            Create
          </button>
        </div>
