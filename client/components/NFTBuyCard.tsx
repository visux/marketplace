...
const NFTBuyCard = ({ nft }: Props) => {
  ...
  return (
    <div className="relative text-gray-200 shadow-homogen bg-background rounded-2xl">
      <span className="absolute z-10 inline-flex items-center px-3 text-sm font-semibold text-intercol rounded-full bg-primary right-2 top-2">
        POS <span className="pl-1 text-xl">{nft.itemId}</span>
      </span>
